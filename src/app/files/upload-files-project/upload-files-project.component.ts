...
@Component({
  selector: 'app-upload-files-project',
  templateUrl: './upload-files-project.component.html',
  styleUrls: ['./upload-files-project.component.css']
})
export class UploadFilesProjectComponent implements OnInit {
  ...
  // @Input() fileExt: string = "JPG, JPEG, PNG, PDF , MP4 ,ZIP , WEBM , DOCX, DOC";
  @Input() fileExt
